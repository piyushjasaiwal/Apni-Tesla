...
img_str = cv2.imread('wheel.png',0)
...
for img in os.listdir(path):
	img1 = image.load_img(os.path.join(path, img),color_mode='grayscale')
	img1 = image.img_to_array(img1) / 255.0
	img = image.load_img(os.path.join(path, img), color_mode = 'grayscale', target_size = [100, 100])
